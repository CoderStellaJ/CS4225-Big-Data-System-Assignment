...
object CommonWords {
    ...
    def main(args: Array[String]) {
        ...
        // 3 input file paths
        val InputFile1 = "../Task1_data/task1-input1.txt"
        val InputFile2 = "../Task1_data/task1-input2.txt"
        val StopWordsFile = "../Task1_data/stopwords.txt"
        val Output = "../Task1_data/output"
        val Delimiter = "[ \t\n\r\f]"
